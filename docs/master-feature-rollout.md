...
4. `server/src/lib/app-domain.ts` — Placeholder `BusinessDomain` with `SEED Northern Rivers` substitution
...
- **Scaffold script**: No changes needed — existing `SEED Northern Rivers`, `seednr`, `seednr-web` placeholders cover all needs
